    ...
    <x-app-layout>
        <form action="{{route("property.store")}}" method="post">
            ...
            <div>
                ...
                <input id="location" name="location" type="text" class="border-2 border-solid border-red-500">

                <input type="number" name="number_of_bathrooms" id="number_of_bathrooms" class="border-2 border-solid border-red-500 float justify-center float-right">
            ...
            <div class="pt-5">
                ...
                <input id="address" name="address" type="text" class="border-2 border-solid border-red-500">
