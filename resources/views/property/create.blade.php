<!DOCTYPE html>
    <x-app-layout>
        ...
        <div>
            ...
            <input id="location" name="location" type="text" class="border-2 border-solid border-red-500" :value="old__("location")" required autofocus autocomplete="location"/>
            <x-input-error :messages="$errors->get("location")" class="mt-2"/>

            <textarea id="description" name="description" class="border-2 border-solid border-red-500 float justify-center float-right"></textarea>
        ...
        <div class="pt-5">
            ...
            <input id="address" name="address" type="text" class="border-2 border-solid border-red-500" :value="old__("address")" required autofocus autocomplete="address">
            <x-input-error :messages="$errors->get("address")" class="mt-2"/>

            <input type="checkbox" name="pets_allowed" id="pets_allowed" class="border-2 border-solid border-red-500 float justify-center float-right mt-7 ml-2">
        ...
        <div class="pt-5">
            ...
            <input type="number" id="max_pets" name="max_pets" class="border-2 border-solid border-red-500 float justify-center float-right">
        ...
        <div class="pt-5">
            ...
            <input type="text" id="price_per_pet" name="price_per_pet" class="border-2 border-solid border-red-500 float justify-center float-right">
        ...
        <div class="pt-5">
            ...
            <input type="text" id="price_per_night" name="price_per_night" class="border-2 border-solid border-red-500 float justify-center float-right">
        ...
        <div class="pt-5">
            ...
            <input id="max_guests" name="max_guests" type="number" class="border-2 border-solid border-red-500">
        </div>

        <div class="pt-5">
            <label for="number_of_bedrooms" class="text-xl">Number of Bedrooms: </label>
            <input id="number_of_bedrooms" name="number_of_bedrooms" type="number" class="border-2 border-solid border-red-500">
        </div>

        <div class="pt-5 flex items-center justify-center">
            <button class="border-2 border-solid border-red-500">Move on to select amenities</button>
        </div>
    </x-app-layout>
</html>
